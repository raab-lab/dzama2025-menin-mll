...
NFYB_peaks='data/processed_data/integrated/nfyb_dor_sig_diff.bed'
SORTORDER='data/processed_data/integrated/nfyb_sort_order.bed'
...
computeMatrix reference-point -S $ATAC\
   -R $SORTORDER \
   --outFileName ${OUTDIR}ATAC_cov_nfyb_peaks_mat.gz\
   --referencePoint center\
   -a 2000\
   -b 2000\
   -bs 10\
...
computeMatrix reference-point -S $K27AC\
   -R $SORTORDER \
   --outFileName ${OUTDIR}k27ac_cov_nfyb_peaks_mat.gz\
   --referencePoint center\
   -a 2000\
   -b 2000\
   -bs 10\
...
computeMatrix reference-point -S $K27ME3\
   -R $SORTORDER \
   --outFileName ${OUTDIR}k27me_cov_nfyb_peaks_mat.gz\
   --referencePoint center\
   -a 2000\
   -b 2000\
   -bs 10\
...
computeMatrix reference-point -S $TEAD\
   -R $SORTORDER \
   --outFileName ${OUTDIR}tead_cov_nfyb_peaks_mat.gz\
   --referencePoint center\
   -a 2000\
   -b 2000\
   -bs 10\
