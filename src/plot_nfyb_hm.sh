...
OUTDIR=plots/cnr/coverages/nfyb_peaks/
...
#   --refPointLabel center
#
#plotHeatmap -m ${INDIR}k27ac_cov_nfyb_peaks_mat.gz \
#   --outFileName ${OUTDIR}k27ac_cov_nfyb_peaks_plot.pdf\
#   --sortRegions keep \
#   --colorMap Blues \
#   --refPointLabel center
#
#
#plotHeatmap -m ${INDIR}k27me_cov_nfyb_peaks_mat.gz \
#   --outFileName ${OUTDIR}k27me_cov_nfyb_peaks_plot.pdf\
#   --sortRegions keep \
#   --colorMap Reds \
#   --refPointLabel center
#
#
#plotHeatmap -m ${INDIR}ATAC_cov_nfyb_peaks_mat.gz \
#   --outFileName ${OUTDIR}atac_cov_nfyb_peaks_plot.pdf\
#   --sortRegions keep \
#   --colorMap Greys \
#   --refPointLabel center
#
#plotHeatmap -m ${INDIR}tead_cov_nfyb_peaks_mat.gz \
#   --outFileName ${OUTDIR}tead_cov_nfyb_peaks_plot.pdf\
#   --sortRegions keep \
#   --colorMap Blues \
#   --refPointLabel center
#
